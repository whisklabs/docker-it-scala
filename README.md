...
```scala
libraryDependencies += "com.whisk" %% "docker-testkit-specs2" % "0.2.0"
```

```scala
libraryDependencies += "com.whisk" %% "docker-testkit-scalatest" % "0.2.0"
```

If you want to configure via typesafe config, also include

```scala
libraryDependencies += "com.whisk" %% "docker-testkit-config" % "0.2.0"
```
